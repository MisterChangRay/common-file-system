<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
    <script>
        function download2() {
            var url = 'http://127.0.0.1:8080/v1/filesys/downloadFile?fileId=bdb035cc785a4499941695e4672e3d89&appKey=test1024&t=123';
...
<body marginheight="0"><h1>common-file-system</h1>
